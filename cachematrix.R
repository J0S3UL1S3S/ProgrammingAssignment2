...
# The purpose of the assignment is to write a pair 
# of functions that create a special object 
# that stores a matrix and caches its inverse, because
# matrix inversion is usually a costly computation 
# and there may be some benefit to caching the inverse
# of a matrix rather than compute it repeatedly. For this 
# assignment, assume that the matrix supplied is 
# always invertible.
...
# from the cache. Computing the inverse of a square matrix
